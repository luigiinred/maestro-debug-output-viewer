...
// Create a simplified version of the server for Electron
console.log("Creating server code for Electron...");
try {
...
module.exports = createServer;
  ...
  console.log("Server code created for Electron.");
} catch (error) {
  console.error("Error creating server code:", error);
  process.exit(1);
}
